...
def k_fold(k, learning_rate, dataset_path, epoch, batch_size, log_path, network):
        ...
        for num in range(epoch):
            ...
            for batch_idx, (wmi) in enumerate(train_loader):
                ...
                if train_step % 10 == 0:
                    ...
                    #                                                                  loss.item()))
                    print("第{}折,第{}epoch 训练次数：{}, Loss2:{} ".format(i + 1, num + 1, train_step,
                                                                                             loss_2.item(),))
            ...
            if network == '1':
                if num == 0:
                    ...
                    torch.save(checkpoint, r'/home/dell/NN/checkpoints/train_total/dataset1/method1/MSE/k_fold_pretrain/UD_kfold_{}fold.pth'.format(i))
                    print('Model Saved')
            ...
            if network == '2':
                if num == 0:
                    ...
                    torch.save(checkpoint,
                               r'/home/dell/NN/checkpoints/train_total/UD_1/UD_1_kfold_{}fold.pth'.format(
                                   i))
                    print('Model Saved')
                if loss2_min > total_validation_loss:
                    loss2_min = total_validation_loss
...
# k_fold(4, learning_rate = 0.00001, dataset_path=r'/home/dell/NN/dataset_list/train_wmi.npy', epoch=50, batch_size=40, log_path = '/home/dell/NN/logs/train_total/dataset1/method1/MSE/k_fold_pretrain')