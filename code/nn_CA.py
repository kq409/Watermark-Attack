...
class ConvBNReLU(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, padding=1):
        ...
        self.Conv = nn.Sequential(
            nn.Conv2d(in_channels=in_channels, out_channels=out_channels, kernel_size=3, stride=2, padding=padding),
...
class Up(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, kernel_size=5):
        super().__init__()
        self.up = nn.Sequential(
            nn.ConvTranspose2d(in_channels, mid_channels, kernel_size=kernel_size),
...
class model_CA(nn.Module):
    def __init__(self, n_channels):
        ...
        self.up1 = Up(512, 512, 2)
        self.up2 = Up(1024, 256, 3)
        self.up3 = Up(512, 256, 5)
        self.up4 = Up(512, 128, 9)
        self.up5 = Up(256, 64, 17)
        self.up6 = Up(128, 32, 33)
        self.up7 = Up(64, 16, 65)

        self.deconv = nn.ConvTranspose2d(32, 3, kernel_size=129)
...
network = model_CA(3)
input_t = torch.ones((2, 3, 256, 256))
